...
var dayArrayMed = new Array('Son', 'Mon', 'Don', 'Mit', 'Do', 'Fre', 'Sam');
...
var monthArrayMed = new Array('Jan', 'Feb', 'Mär', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dez');
...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  // add an iFrame to allow the datepicker to display above selection lists
  adjustiFrame();
}
...
function datePickerClosed(dateField)
{
  ...
  if (dateField.name == "StartDate") {
    if (dateObj < today) {
      ...
      alert("Es werden keine Daten aus der Vergangenheit akzeptiert");
      dateField.value = "";
